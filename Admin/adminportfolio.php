    ...
    <section id="header">
        ...
        <div>
            <ul id="navbar">
                ...
                <li><a class="active" href="adminportfolio.php">Portfolio</a></li>
    ...
    <?php 
        ...
        ?>
             ...
             <tr class="tbody">
               ...
               <td>
                   <a href="edit.php?id=<?= $rows['id']; ?>" class="btn btn-info">Edit</a>
                   <form action="../Portfolio/portfolio.php" method="post" class="d-inline">
