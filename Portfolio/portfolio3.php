     ...
     if($emailcount<1) {
            ...
            echo '<script>window.location.href="../signup.php";</script>'; 
             ...
             if($iquery){
                     ...
                     echo '<script>window.location.href="portfolio3.php";</script>';  
             }
             else 
             {
                 ?>
...
?>
  ...
  <nav class="w3-sidebar w3-collapse w3-animate-left" style="z-index:3;width:300px;  background: #e3e6f3;" id="mySidebar"><br>
    <div class="w3-container">
      ...
      <img src="img/r3.jpeg" style="width:45%;" class="w3-round"><br><br>
  ...
  <div class="w3-main" style="margin-left:300px">
    ...
    <div class="w3-row-padding">
      <div class="w3-third w3-container w3-margin-bottom">
        <img src="img/p1.jpeg" alt="Norway" style="width: 75%" class="w3-hover-opacity">
        <div class="w3-container w3-white">
          <p><b>Blue Cushion</b></p>
        </div>
      </div>
      <div class="w3-third w3-container w3-margin-bottom">
        <img src="img/p2.jpeg" alt="Norway" style="width:89%" class="w3-hover-opacity">
        <div class="w3-container w3-white">
          <p><b>Pattern Cushion</b></p>
        </div>
      </div>
      <div class="w3-third w3-container">
        <img src="img/p3.jpeg" alt="Norway" style="width:93%" class="w3-hover-opacity">
        <div class="w3-container w3-white">
          <p><b>Cushion</b></p>
        </div>
      </div>
    ...
    <div class="w3-row-padding">
      <div class="w3-third w3-container w3-margin-bottom">
        <img src="img/p4.jpeg" alt="Norway" style="width:75%" class="w3-hover-opacity">
        <div class="w3-container w3-white">
      ...
      <div class="w3-third w3-container w3-margin-bottom">
        <img src="img/p5.jpeg" alt="Norway" style="width:79%" class="w3-hover-opacity">
        <div class="w3-container w3-white">
          <p><b>Embroidery Cushion Cover</b></p>
         
        </div>
      </div>
      <div class="w3-third w3-container">
        <img src="img/p6.jpeg" alt="Norway" style="width:93%" class="w3-hover-opacity">
        <div class="w3-container w3-white">
          <p><b>Modern Cushion Cover</b></p>
        </div>
      </div>
    </div>
    ...
    <div class="w3-row-padding w3-padding-16" id="about">
      <div class="w3-col m6">
        <img src="img/r3.jpeg" alt="Me" style="width:30%">
      </div>
    </div>
  
    <div class="w3-container w3-padding-large" style="margin-bottom:32px">
      <h4><b>About Me</b></h4>
      <p>Creative and passionate alterations tailor with 4 years of experience designing and creating fashionable Cushion.The best seat cushion engineered to be a customers' favorite!</p>
      <hr>
      ...
      <div class="w3-row-padding" style="margin:0 -16px">
        <div class="w3-third w3-margin-bottom">
          <ul class="w3-ul w3-border w3-white w3-center w3-opacity w3-hover-opacity-off">
            ...
            <li class="w3-padding-16">Color Choice</li> 
    ...
    <div class="w3-container w3-padding-large">
      ...
      <hr class="w3-opacity">
      <form action="portfolio3.php" method="post">
        ...
        <input type="text" value="Elena Dine" name="pname" hidden>
