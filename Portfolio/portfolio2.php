     ...
     if($emailcount<1) {
            ...
            echo '<script>window.location.href="../signup.php";</script>'; 
             ...
             if($iquery){
                     ...
                     echo '<script>window.location.href="portfolio2.php";</script>';  
             }
             else 
             {
                 ?>
...
?>
  ...
  <nav class="w3-sidebar w3-collapse w3-animate-left" style="z-index:3;width:300px;  background: #e3e6f3;" id="mySidebar"><br>
    <div class="w3-container">
      ...
      <img src="img/r2.jpeg" style="width:45%;" class="w3-round"><br><br>
      <h4><b>Eugene Levy</b></h4>
    </div>
  ...
  <div class="w3-main" style="margin-left:300px">
    ...
    <div class="w3-row-padding">
      <div class="w3-third w3-container w3-margin-bottom">
        <img src="img/p19.jpeg" alt="Norway" style="width:90%" class="w3-hover-opacity">
        <div class="w3-container w3-white">
          <p><b>White One-Peice</b></p>
        </div>
      </div>
      <div class="w3-third w3-container w3-margin-bottom">
        <img src="img/p20.jpeg" alt="Norway" style="width:72%" class="w3-hover-opacity">
        <div class="w3-container w3-white">
          <p><b>Leather Jacket</b></p>
        </div>
      </div>
      <div class="w3-third w3-container">
        <img src="img/p21.jpeg" alt="Norway" style="width:90%" class="w3-hover-opacity">
        <div class="w3-container w3-white">
          <p><b>Jeans</b></p>
        </div>
      </div>
    ...
    <div class="w3-row-padding">
      <div class="w3-third w3-container w3-margin-bottom">
        <img src="img/p22.jpeg" alt="Norway" style="width:60%" class="w3-hover-opacity">
        <div class="w3-container w3-white">
          <p><b>Nude Shirt</b></p>
      ...
      <div class="w3-third w3-container w3-margin-bottom">
        <img src="img/p23.jpeg" alt="Norway" style="width:80%" class="w3-hover-opacity">
        <div class="w3-container w3-white">
          <p><b>Rainbow Outfit</b></p>
         
        </div>
      </div>
      <div class="w3-third w3-container">
        <img src="img/p24.jpeg" alt="Norway" style="width:95%" class="w3-hover-opacity">
        <div class="w3-container w3-white">
          <p><b>Black Shirt & Pant</b></p>
        </div>
      </div>
    </div>
    ...
    <div class="w3-row-padding w3-padding-16" id="about">
      <div class="w3-col m6">
        <img src="img/r2.jpeg" alt="Me" style="width:30%">
      </div>
    </div>
    ...
    <div class="w3-container w3-padding-large" style="margin-bottom:32px">
      ...
      <div style="background: #e3e6f3;">
        <div class="w3-container w3-padding w3-center" style="width:90%; background: #088178;">90%</div>
      </div>
      <p>Design</p>
      <div style="background: #e3e6f3;">
        <div class="w3-container w3-padding w3-center" style="width:75%; background: #088178;">75%</div>
      </div>
      <p>Quality</p>
      <div style="background: #e3e6f3;">
    ...
    <div class="w3-container w3-padding-large">
      ...
      <hr class="w3-opacity">
      <form action="portfolio2.php" method="post">
        ...
        <input type="text" value="Eugene Levy" name="pname" hidden>
