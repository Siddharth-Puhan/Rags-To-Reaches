     ...
     if($emailcount<1) {
            ...
            echo '<script>window.location.href="../signup.php";</script>'; 
             ...
             if($iquery){
                     ...
                     echo '<script>window.location.href="portfolio4.php";</script>';  
             }
             else 
             {
                 ?>
...
?>
  ...
  <nav class="w3-sidebar w3-collapse w3-animate-left" style="z-index:3;width:300px;  background: #e3e6f3;" id="mySidebar"><br>
    <div class="w3-container">
      ...
      <img src="img/r4.jpeg" style="width:45%;" class="w3-round"><br><br>
      <h4><b>George Klein</b></h4>
    </div>
  ...
  <div class="w3-main" style="margin-left:300px">
    ...
    <div class="w3-row-padding">
      <div class="w3-third w3-container w3-margin-bottom">
        <img src="img/p7.jpeg" alt="Norway" style="width:80%" class="w3-hover-opacity">
        <div class="w3-container w3-white">
          <p><b>Mattress</b></p>
        </div>
      </div>
      <div class="w3-third w3-container w3-margin-bottom">
        <img src="img/p8.jpeg" alt="Norway" style="width:80%" class="w3-hover-opacity">
        <div class="w3-container w3-white">
          <p><b>Double Color Mattress</b></p>
        </div>
      </div>
      <div class="w3-third w3-container">
        <img src="img/p9.jpeg" alt="Norway" style="width:80%" class="w3-hover-opacity">
        <div class="w3-container w3-white">
          <p><b>Solid Green Color Mattress</b></p>
        </div>
      </div>
    </div>
    ...
    <div class="w3-row-padding">
      <div class="w3-third w3-container w3-margin-bottom">
        <img src="img/p10.jpeg" alt="Norway" style="width:60%" class="w3-hover-opacity">
        <div class="w3-container w3-white">
          <p><b>Grey Mattress Cover</b></p>
          
        </div>
      </div>
      <div class="w3-third w3-container w3-margin-bottom">
        <img src="img/p12.jpeg" alt="Norway" style="width:80%" class="w3-hover-opacity">
        <div class="w3-container w3-white">
          <p><b>Round Mattress</b></p>
         
        </div>
      </div>
      <div class="w3-third w3-container">
        <img src="img/p11.jpeg" alt="Norway" style="width:80%" class="w3-hover-opacity">
        <div class="w3-container w3-white">
          <p><b>Mattress Cover</b></p>
        </div>
      </div>
    </div>
    ...
    <div class="w3-row-padding w3-padding-16" id="about">
      <div class="w3-col m6">
        <img src="img/r4.jpeg" alt="Me" style="width:30%">
      </div>
    </div>
  
    <div class="w3-container w3-padding-large" style="margin-bottom:32px">
      <h4><b>About Me</b></h4>
      <p>Creative and passionate alterations tailor with 4 years of experience designing and creating fashionable Mattress.  The basic necessity for a right and perfect sleep is a perfect mattress that would comfort your body, mind and soul. Mattress are consider as the key factor for a perfect slumber.</p>
      <hr>
      ...
      <p>Quality</p>
      <div style="background: #e3e6f3;">
        <div class="w3-container  w3-padding w3-center" style="width:80%; background: #088178;">80%</div>
      </div>
      <hr>
      ...
      <div class="w3-row-padding" style="margin:0 -16px">
        <div class="w3-third w3-margin-bottom">
          <ul class="w3-ul w3-border w3-white w3-center w3-opacity w3-hover-opacity-off">
            ...
            <li class="w3-padding-16">Size of your choice</li>
    ...
    <div class="w3-container w3-padding-large" >
      ...
      <hr class="w3-opacity">
      <form action="portfolio4.php" method="post">
        ...
        <input type="text" value="George Klein" name="pname" hidden>
